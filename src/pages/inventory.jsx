    ...
    <div className="flex flex-col gap-y-3 m-4">
      ...
      <div className="flex flex-row justify-between items-center">
        ...
        <div className="flex flex-row gap-x-2 items-center">
          ...
          <input type="text" placeholder="Cari barang" className="h-7 p-3 border border-dark-3 outline-none rounded" />
          <button className="btn-primary">Cari</button>
        </div>
        {/* btn add item */}
        <button className="btn-secondary">Tambah Barang</button>
      </div>
      {/* table */}
